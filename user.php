...
<body>
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="user.php?id=<?php echo $id ?>">Thông tin cá nhân</a></li>
                            </ol>
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-2 text-sm-right">Số điện thoại</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control"value="<?php echo $row['phone']; ?>" id="phone">
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-2 text-sm-right">Lần đăng nhập cuối: </label>
                                        <div class="col-sm-10">
                                            <p class="col-form-label col-sm-2 text-sm-right"><?php echo formatDate($row['last_login']); ?></p>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-10 ml-sm-auto">
                                            <button type="button" class="btn btn-primary" id="changeInfo-sbmit">Lưu thay đổi</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
        $(document).ready(function(){
            var uid = $("#uid").val();
            $("#changeInfo-sbmit").on('click', function(){
                var name = $("#name").val();
                var phone = $("#phone").val();
                var email = $("#email").val();
                $.ajax({
                    url: "handlers/change_user_info.php",
                    method: "post",
                    data:{
                        submit:"true",
                        id:uid,
