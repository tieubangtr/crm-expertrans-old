<?php
    ...
    $index = $start + 1;
    if($type == "none"){
        $sql = "select o.*, u1.name as nguoitao_name, u2.name as nguoiphutrach_name from organizations o, users u1, users u2 where o.nguoitao = u1.id and o.nguoiphutrach = u2.id and o.nguoitao = '$id' order by id desc limit ".$start.", ".$record_per_page.";";
    }else{
        $sql = "select o.*, u1.name as nguoitao_name, u2.name as nguoiphutrach_name from organizations o, users u1, users u2 where o.nguoitao = u1.id and o.nguoiphutrach = u2.id and tinhtrang = '$type' and o.nguoitao = '$id' order by id desc limit ".$start.", ".$record_per_page.";";
    }
