<?php
    ...
    $sql2 = "select * from customer where id = '$cus_id';";
                                ...
                                <form>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="custom-select" id="select-nguoiphutrach">
                                                <option>Website</option>
                                                <option>Facebook</option>
                                                <option>Google</option>
                                                <option>Hotline</option>
                                                <option>Đối tác</option>
                                                <option>Nguồn cá nhân</option>
                                                <option>Nguồn giới thiệu</option>
                                                <option>Nguồn VPDD</option>
                                                <option>Đinh Khắc Tuấn</option>
                                                <option>EI Marketing</option>
                                            </select>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#submit-btn').on('click', function(){
                ...
                var nguoiphutrach = $("#select-nguoiphutrach").val();
