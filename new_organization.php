                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="organizations.php?id=<?php echo $id ?>">Quản lý tổ chức</a></li>
                                <li class="breadcrumb-item"><a href="new_organization.php?id=<?php echo $id ?>">Thêm mới tổ chức</a></li>
                            </ol>
                        </div>
                        <div class="card mb-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group filter-component">
                                                ...
                                                <select ng-model="name" class="form-control input-lg" data-live-search="true" name="select-manager" id="select-manager" title="Chọn người phụ trách">
                                                    <option value="<?php echo $id ?>" selected><?php echo $row_get_user_info['name']." - ".$row_get_user_info['email'] ?></option>
                                                </select>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#submit-btn').on('click', function(){
                ...
                $.ajax({
                    url: "handlers/add_new_organization_user.php",
                    method: "post",
                    data:{
                        submit: 'true',
                        id: uid,
