<?php
    ...
    $id = $_GET['id'];
    $sql_get_user_info = "select * from users where id = '$id'";
    $result_get_user_info = mysqli_query($connection, $sql_get_user_info);
    $row_get_user_info = mysqli_fetch_assoc($result_get_user_info);
    if(isset($_GET['type'])){
        $type = $_GET['type'];
        $search = "none";
        $sql = "select o.*, u1.name as nguoitao_name, u2.name as nguoiphutrach_name from organizations o, users u1, users u2 where o.nguoitao = u1.id and o.nguoiphutrach = u2.id and o.tinhtrang = '$type' and o.nguoitao = '$id' order by id desc limit 10";
        ...
        $type = 'none';
        $search = $_GET['search'];
        $sql = "select o.*, u1.name as nguoitao_name, u2.name as nguoiphutrach_name from organizations o, users u1, users u2 where o.nguoitao = u1.id and o.nguoiphutrach = u2.id and o.name like '%".$search."%' and o.nguoitao = '$id' order by id desc limit 10";
        ...
        $type = 'none';
        $search = "none";
        $sql = "select o.*, u1.name as nguoitao_name, u2.name as nguoiphutrach_name from organizations o, users u1, users u2 where o.nguoitao = u1.id and o.nguoiphutrach = u2.id and o.nguoitao = '$id' order by id desc limit 10";
...
<body>
                        ...
                        <label class="nav-item navbar-text navbar-search-box p-0 active" >
                            ...
                            <span>
                                <form style="width: 550px;">
                                    <input type="text" class="form-control navbar-text mx-2" placeholder="Tìm kiếm tổ chức..." style="width: 350px;" id="search-input" style="display:inline-block;">
                        ...
                        <div class="demo-navbar-user nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                                <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                                    <span class="px-1 mr-lg-2 ml-2 ml-lg-0"><?php echo $row_get_user_info['email'] ?></span>
                                </span>
                            </a>
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="organization.php?id=<?php echo $id; ?>">Quản lý tổ chức</a></li>
                            </ol>
                        </div>
                        <!-- table here -->
                        <div style="margin: 15px;">
                            <button type="button" class="btn btn-lg btn-success" onclick="new_or(<?php echo $id ?>)">
                                Thêm mới
                            </button>
                        </div>
                                ...
                                <table class="table card-table" >
                                    ...
                                    <tbody id="contact-data">
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <button type="button" class="btn btn-sm btn-outline-primary viewData" style="margin-left: 10px;" id="cus-<?php echo $row['id'];?>">Sửa</button>
    ...
    <script>
        function new_or(uid){
            document.location.href = "new_organization.php?id=" + uid;
        }
        function search_contact(uid){
            var val = document.getElementById("search-input").value;
            document.location.href = "organization.php?id=" + uid + "search=" + val;
        }
    </script>
    <script>
        $(document).ready(function(){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(data == "ok"){
                            ...
                            document.location.href = 'organizations.php?id=' + uid;
                        }else if(data == 'empty'){
                            console.log("empty");
            ...
            $(document).on('click', '#prev-page', function(){
                ...
                if(parseInt($('#page-number').val()) != 1){
                    $.ajax({
                        url: "handlers/organization_pagination_user.php",
                        method:"post",
                        data:{
                            page: page,
                            request: 'prev',
            ...
            $('#moi').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=moi";
            });
            $('#quantam').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=quantam";
            });
            $('#tiemnang').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=tiemnang";
            });
            $('#datlichhen').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=datlichhen";
            });
            $('#hocthu').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=hocthu";
            });
            $('#saisodienthoai').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=saisodienthoai";
            });
            $('#chuanghemay').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=chuanghemay";
            });
            $('#saidoituong').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=saidoituong";
            });
            $('#khongconhucau').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=khongconhucau";
            });
            $('#sapchot').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=sapchot";
            });
            $('#kyhopdong').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=kyhopdong";
            });
            $('#dathutiendot1').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=dathutiendot1";
            });
            $('#dathutiendot2').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=dathutiendot2";
            });
            $('#dungquen').on('click', function(){
                document.location.href = "organizations.php?id=" + uid +"&type=dungquen";
            });
        });
    </script>
